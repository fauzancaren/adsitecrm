    ...
    <div class="card-body">
        ...
        <div class="">
            <ul class="list-group list-group-flush">
                ...
                $data = $this->db->query("SELECT * FROM leads WHERE status =  'Visit' AND category IN ('New','Cold','Warm','Hot','Reserve','Booking')  AND date_visit BETWEEN '$interval' AND '$tanggal_sekarang' ORDER BY id DESC ")->result_array();
