    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown dropdown-animated scale-left mr-2 ">
            ...
            <div class="dropdown-menu">
                ...
                <a href="<?= base_url("admin/contacted/leads") ?>" class="dropdown-item btn" type="button">Contacted</a>
    ...
    <div class="card-body">
        ...
        <div class="">
            <ul class="list-group list-group-flush">
                ...
                $data = $this->db->query("SELECT * FROM leads WHERE category = 'Pending' AND date_new BETWEEN '$interval' AND '$tanggal_sekarang' ORDER BY id DESC ")->result_array();
