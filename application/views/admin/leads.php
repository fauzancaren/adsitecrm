...
-->
        <div class="navbar-page">
            ...
            <div class="tab-content row p-2" id="pills-tabContent">
                ...
                <div class="tab-pane fade col" id="pills-contacted" role="tabpanel" aria-labelledby="pills-contacted-tab">
                    <div class="row d-flex justify-content-between align-items-center p-2">
                        <span>Contacted</span>
                        <div class="dropdown dropdown-animated  scale-left ">
                            <button type="button" class="btn btn-sm dropdown-toggle" data-toggle="dropdown">
                ...
                <div class="tab-pane fade col" id="pills-visit" role="tabpanel" aria-labelledby="pills-visit-tab">
                    <div class="row d-flex justify-content-between align-items-center p-2">
                        <span>Visit</span>
                        <div class="dropdown dropdown-animated  scale-left ">
                            <button type="button" class="btn btn-sm dropdown-toggle" data-toggle="dropdown">
                ...
                <div class="tab-pane fade col" id="pills-close" role="tabpanel" aria-labelledby="pills-close-tab">
                    <div class="row d-flex justify-content-between align-items-center p-2">
                        <span>Close</span>
                        <div class="dropdown dropdown-animated  scale-left ">
                            <button type="button" class="btn btn-sm dropdown-toggle" data-toggle="dropdown">
